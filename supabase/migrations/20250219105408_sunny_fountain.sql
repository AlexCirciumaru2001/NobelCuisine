/*
  # Fix table bookings relationship with profiles

  1. Changes
    - Add foreign key constraint between table_bookings and profiles
    - Update existing policies to use profiles relationship
*/
